...
extension LibraryCellView {
        ...
        private func _contextActionsExtra(for app: AppInfoPresentable) -> some View {
                if app.isSigned {
                        ...
                        Button(.localized("Clone App"), systemImage: "square.on.square") {
                                AutoSignQueue.shared.cloneApp(app)
                        }
                        Button(.localized("Hold Updates"), systemImage: "pause.circle") {
                                UpdateEngine.shared.holdUpdates(forBundleID: app.identifier ?? "")
                        }
