...
struct FileRow: View {
    ...
    private func fileConfirmationDialogButtons() -> some View {
        ...
        if file.isASignFile {
            Button {
                UIAlertController.showAlertWithOk(title: "?", message: .localized("ASign certificate file (.asign) is now unsupported from v1.5.1, please refer to use .p12 and .mobileprovision instead."))
            } label: {
